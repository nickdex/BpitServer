...
import com.nick.bpit.core.PayloadProcessor;
import com.nick.bpit.core.ProcessorFactory;
...
import com.nick.bpit.helper.TimeStamp;
...
public class CcsClient implements Config {
    ...
    public void sendBroadcast(Map<String, String> payload,Map<String, String> notification, String collapseKey,
        ...
        Map map = createAttributeMap(null, null, payload,notification, collapseKey,
     ...
     */
    public static String createJsonMessage(String to, String messageId, Map<String, String> payload,Map<String, String> notification,
            String collapseKey, Long timeToLive, Boolean delayWhileIdle) {
        return createJsonMessage(createAttributeMap(to, messageId, payload,notification,
    ...
    public static Map createAttributeMap(String to, String messageId, Map<String, String> payload, Map<String, String> notification,
            String collapseKey, Long timeToLive, Boolean delayWhileIdle) {
    ...
    public static void main(String... args) {
        RegIdManager idManager = new RegIdManager();
        String message = args[0];
        String regId = "";
        CcsClient ccsClient = CcsClient.prepareClient(PROJET_NUMBER, SERVER_KEY, true);
        try {
            regId = idManager.getAdmin();
        } catch (Exception e) {
        ...
        try {
            ...
            System.out.println("Could not connect to CCS.\n" + e);
        }
        ...
        payload.put(EMAIL, "SERVER");
        payload.put(TIMESTAMP, TimeStamp.getTimeStamp());
        payload.put(ACTION, "BROADCAST");
        /*
        notification.put("title", "Nick's Server");
        notification.put("body", payload.get(Config.MESSAGE));
        notification.put("click_action", "MAIN");
        notification.put("icon", "small_icon");
        */
        String collapseKey = "sample";
        Long timeToLive = 10000L;
        Boolean delayWhileIdle = true;
        
        ccsClient.send(createJsonMessage(regId, messageId, payload, null, collapseKey,
                timeToLive, delayWhileIdle));
    }
}
